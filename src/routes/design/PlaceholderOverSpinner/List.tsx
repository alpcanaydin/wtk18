...
const PlaceholderOverSpinner = () => (
  <List>
    <ListItem title="Title 1" body={summary1} to="/gorsellik/spinner-yerine-placeholder/detay" />
    <ListItem title="Title 2" body={summary2} to="/gorsellik/spinner-yerine-placeholder/detay" />
  </List>
);
